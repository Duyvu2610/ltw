...
<body>
			...
			<div
				...
				<div class="max-w-md w-full space-y-8">
					<div class="text-center">
						<h2 class="mt-6 text-3xl font-bold text-gray-900">Let’s go</h2>
					</div>
					...
					<form class="space-y-4 md:space-y-6 group font-medium " action="register"
						method="post" novalidate>
							...
							<div>
								<label for="uname"
									class="block mb-2 text-sm font-medium text-gray-900">User name <span class = "text-red-700 font-bold">*</span></label> <input type="text" placeholder="Vu"
	    ...
	    "
						...
						<div>
							<label for="email"
								...
								<span>Your email <span class = "text-red-700 font-bold">*</span></span>
    ...
    Password least than 4 character
						...
						<div>
							<label for="confirm-password"
								class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm password <span class = "text-red-700 font-bold">*</span></label> <input type="password" placeholder="************"
								class="mt-1 block w-full px-3 py-2  border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
	      focus:outline-none focus:border-[#316BFF] focus:ring-1 focus:ring-[#316BFF] bg-gray-50 invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500 peer
	    "
    ...
    Password least than 4 character
						...
						<button type="submit"
							...
							group-invalid:pointer-events-none group-invalid:opacity-30">Sign
							up</button>
